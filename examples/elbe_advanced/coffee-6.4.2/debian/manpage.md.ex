...
coffee - program to do something

# SYNOPSIS

**coffee** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**coffee** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **coffee** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**coffee** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    coffee. See **foo.conf**(5) for further details.
...
**coffee** provides some return codes, that can be used in scripts:
