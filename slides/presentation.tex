...
\begin{frame}{How to realize this project with Elbe?}
	\begin{block}{Using the latest QT version}
		How to implement the coffee machine project with Elbe using the latest QT version?
	\end{block}

	\begin{block}{Warning}
		This approach has the drawback that you have to maintain your QT version!
	\end{block}
\end{frame}
